{!! Form::open(['route' => 'admin.holiday.store', 'method' => 'POST', 'id' => 'formHolidayRegister']) !!}
    ...
    <div class="modal-footer p-0 pt-3 border-top-0 d-flex justify-content-end">
        ...
        <button type="submit" class="btn btn-sm text-white" style="background-color: #071D38;"><i class="fas fa-save"></i> Guardar Feriado</button>
    </div>
{!! Form::close() !!}