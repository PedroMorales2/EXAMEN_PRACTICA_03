{!! Form::open(['route' => 'admin.vacation.store', 'method' => 'POST', 'id' => 'formVacationRegister']) !!}
    ...
    <div class="modal-footer p-0 pt-3 border-top-0 d-flex justify-content-end">
        ...
        <button type="submit" class="btn btn-sm text-white" style="background-color: #071D38;"><i class="fas fa-save"></i> Registrar Solicitud</button>
    </div>
{!! Form::close() !!}